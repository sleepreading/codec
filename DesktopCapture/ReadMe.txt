========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Cap
========================================================================


AppWizard has created this Cap application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Cap application.
...
res\Cap.ico
    ...
    icon is included by the main resource file Cap.rc.
...
DlgCap.h, DlgCap.cpp - the dialog
    These files contain your CDlgCap class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Cap.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CCapDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Cap.pch and a precompiled types file named StdAfx.obj.
